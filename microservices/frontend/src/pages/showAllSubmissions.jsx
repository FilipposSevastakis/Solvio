...
const ShowMySubmissions = () => {
  ...
  // when closing modal containing user information
  const handleCloseUserInfoModal = (e) => {
    setProblemUserID("");
    setProblemUsername("");
    setProblemUserCredits("");
    setProblemUserEmail("");
    setProblemUserPicture("");
    setUserJoinedAt("");
          ...
          >
            <div className="modal-box px-4 flex flex-col items-center justify-center overflow-auto">
              {problemUserJoinedAt === "" ? (
                <div
                  role="status"
                  className="flex w-48 h-96 justify-center items-center"
                >
                  <svg
                    aria-hidden="true"
                    class="w-20 h-20 text-gray-200 animate-spin dark:text-gray-300 fill-orange-800 mb-4"
                    viewBox="0 0 100 101"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
